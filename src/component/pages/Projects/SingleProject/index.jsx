                ...
                <React.Fragment key={dev.id}>
                  ...
                  <div className={classes[`SingleProject-info`]}>
                    ...
                    <div className={classes[`SingleProject-info--content`]}>
                      <div
                        className={
                          classes[`SingleProject-info--content-description`]
                        }
                      >
                        <h3>Description</h3>
                        <p>{dev.content}</p>
                      ...
                      <div
                        className={classes[`SingleProject-info--content-links`]}
                      >
                        <h3>Links</h3>
                        <div
                          className={
                            classes[`SingleProject-info--content-links--list`]
                          }
                        >
